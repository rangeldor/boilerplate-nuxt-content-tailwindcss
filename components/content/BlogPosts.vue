<template>
  <slot :posts="posts">
    <section class="not-prose font-mono">
      <div class="column text-sm text-gray-700 dark:text-gray-500">
        <div>date</div>
        <div>title</div>
      </div>
          ...
          >
            <div
              :class="{
                ...
                'text-gray-700 dark:text-gray-500': post.displayYear
              }"
            >
              {{ post.year }}
            </div>
...
<style scoped>
.column {
  @apply flex items-center space-x-8 border-b border-gray-200 py-2 dark:border-gray-700;
}
</style>
